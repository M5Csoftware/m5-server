...
export async function PUT(req) {
    try {
        ...
        // If new amount is higher, deduct from balance (debit)
        // If new amount is lower, add to balance (credit)
        ...
        console.error("Error in auto-calculation update:", error.message, error.stack);
        return NextResponse.json(
